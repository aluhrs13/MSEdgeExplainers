...
As of November 14th 2024, this explainer has been replaced with [HandwritingIntentCSSValue](HandwritingIntentCSSValue.md) which proposes a new keyword for the `touch-action` CSS attribute.
